...
class SearchTest extends TestCase
{
    ...
    {
    	$this->assertSame($this->request, $this->request->setGeocode('37.781157', '-122.398720', '1mi'));
    }
    ...
    {
    	$this->assertSame($this->request, $this->request->setLanguage('fr'));
    }
    ...
    public function testsetLocaleReturnsSelf()
    {
    	$this->assertSame($this->request, $this->request->setLanguage('fr'));
    }
    ...
    public function testsetResultTypeReturnsSelf()
    {
    	$this->assertSame($this->request, $this->request->setResultType('mixed'));
    }
